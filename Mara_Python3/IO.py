...
from Mara_Python3.Atom import *
#from Mara.Library import libLingua, omniTranslator
from Mara_Python3.Library import atomTranslator, omniTranslator
from Mara_Python3.Library.Lingua import libLingua
from Mara_Python3.aux import ArgumentError, SpongeStream, escape_parentheses, \
        complement, intersection
from Mara_Python3.NMR import DCouplings, Coupling, Couplings
from Mara_Python3 import loki
        ...
        while True:
            ...
            if len(parts) != self.__size__:
                if key == '&':
                    ...
                    break
                # Condition for passing over comment lines added by HMC clinic, Feb 2019
