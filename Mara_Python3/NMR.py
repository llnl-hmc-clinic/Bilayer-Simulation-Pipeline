...
import string
from Mara_Python3.aux import BasicIterator
...
class DCoupling:
    ...
    def __repr__(self):
        ...
        return '%s'%(main + gamma + string.center('atoms: %s\t'%repr(self.atoms), \
...
from Mara_Python3.Physics import gyromagnetic_constants as __gyros__
